    ...
    <nav class="px-8 md:px-16 lg:px-24 xl:px-32 mx-auto lg:container">
      <div class="mx-auto">
        <div class="flex items-center justify-between h-20">
          <nuxt-link to="/" class="flex items-center text-xl font-semibold">
            <div class="flex-shrink-0">
              <div class="flex flex-col justify-center items-center w-8 h-8 mr-3 text-primary-blue">
          ...
          <ul class="items-center justify-around hidden lg:flex flex-grow px-8 xl:px-16 max-w-screen-md">
            <li class="text-sm">Use Cases</li>
            <li class="text-sm">Documentation</li>
            <li class="text-sm">Articles</li>
            <li class="text-sm">Old Portal</li>
          </ul>
          <a
            small
            class="px-4 h-8 hidden lg:flex flex-shrink transition duration-150 cursor-pointer font-semibold items-center bg-primary-blue rounded text-sm text-white hover:bg-primary-blue-hover"
            >Dashboard<svg
              class="ml-2"
              width="12"
              height="10"
          ...
          <AppBtnSecondary small class="bg-opacity-25 lg:hidden bg-primary-blue" @click="toggleMenu">
            <div class="flex justify-center items-center h-6 w-6 px-1 text-primary-blue">
              <svg
                v-if="menuOpened"
